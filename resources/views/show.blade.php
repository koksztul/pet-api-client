...
<div id="form">
    ...
    <form id="petUpdateForm" method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="category" name="category" placeholder="Category" disabled>
            @error('category')
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="photoUrls" name="photoUrls" placeholder="photoUrls" disabled> 
            @error('photoUrls')
            <small class="text-danger">
                {{ $message }}
            </small>  
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="tags" name="tags" placeholder="tags" data-role="tagsinput" disabled>
            @error('tags')
            <small class="text-danger">
                {{ $message }}
            </small>  
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="status" name="status" placeholder="status" disabled>
            @error('status')
            <small class="text-danger">
                {{ $message }}
            </small>  
